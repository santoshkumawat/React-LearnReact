...
const UseStateEx = () => {
  ...
  return (
    <div>
      ...
      <p>
        <strong>
          A state of component is a variable that holds some information thay
      ...
      <p>
        <strong>
          Whenever the <em>value</em> of the state changes, the{" "}
          <em>component re-renders</em> itself with <em>updated values.</em>
        </strong>
      </p>
      <br />
